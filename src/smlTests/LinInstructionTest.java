...
public class LinInstructionTest {
	private String fileName = "src" + File.separator + "linTest.txt";
	private File file;
	...
	public void buildUp(){
		...
		try (PrintWriter out = new PrintWriter(file)){
			out.println("f0 lin 0 30");
			out.println("f1 lin 1 16");
			out.println("f2 lin 2 25"); 
	...
	public void linTest(){
		...
		testerRegisters.setRegister(2, 25);
		testerMachine = new Machine();
		Translator TranslatorTester = new Translator("linTest.txt");
